    ...
    public function run(): void
    {
        Diagnostic::query()->insert([
            ...
            'image_disease' => json_encode([
                ...
                'https://storage.googleapis.com/hidroqu/diagnostics/sehat-3.png',
            ]),
        ...
        Diagnostic::query()->insert([
            ...
            'image_disease' => json_encode([
                'https://storage.googleapis.com/hidroqu/diagnostics/kalium-1.png',
                'https://storage.googleapis.com/hidroqu/diagnostics/kalium-2.png',
        ...
        Diagnostic::query()->insert([
            ...
            'image_disease' => json_encode([
                'https://storage.googleapis.com/hidroqu/diagnostics/nitrogen-1.png',
                'https://storage.googleapis.com/hidroqu/diagnostics/nitrogen-2.png',
                'https://storage.googleapis.com/hidroqu/diagnostics/nitrogen-3.png',
            ]),
        ...
        Diagnostic::query()->insert([
            ...
            'image_disease' => json_encode([
                ...
                'https://storage.googleapis.com/hidroqu/diagnostics/fosfor-3.png',
            ]),
