<x-app-layout>
    <section id="home" class="hero bg-primary text-primary-content py-20 md:px-8">
        <div class="hero-content flex-col lg:flex-row-reverse">
            <img src="{{ asset('hero.png') }}" class="max-w-xs" alt="Mockup 1">
            <div>
                ...
                <p class="py-6">
                    ...
                    AI.
                    Identifikasi kekurangan nutrisi dan optimalkan budidaya hidroponik Anda.
                </p>
    ...
    <section id="about" class="scroll-mt-20 bg-base-100 text-base-content py-12">
        <div class="container mx-auto px-4 flex flex-col lg:flex-row items-center">
            ...
            <div class="max-w-lg border-2 border-dashed border-neutral p-4 h-72 w-full flex items-center justify-center overflow-hidden">
                <img src="{{ asset('about.jpg') }}" class="w-full h-full object-cover border border-base-200" alt="Mockup 2">
            </div>
        </div>
    </section>
    ...
    <section id="features" class="scroll-mt-20 py-20 px-6 bg-gradient-to-br from-white to-base-100 text-center">
        ...
        <div class="container xl:px-40 mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div
                ...
                <div class="card-body p-4">
                    <div class="w-full h-72 bg-slate-300 mb-4 overflow-hidden rounded-lg">
                        <img src="{{ asset('scan.png') }}" class="w-full h-full object-cover" alt="Mockup 2">
                    </div>
                    <h3 class="text-xl font-bold mb-2">Scan Nutrisi Tanaman</h3>
                    <p class="text-base leading-relaxed">Analisis cepat dan akurat. Cukup scan daun tanaman Anda untuk mengetahui
                        kandungan nutrisi dan kondisi kesehatan tanaman secara real-time.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="card-body p-4">
                    <div class="w-full h-72 bg-slate-300 mb-4 overflow-hidden rounded-lg">
                        <img src="{{ asset('notif.png') }}" class="w-full h-full object-cover" alt="Mockup 2">
                    </div>
                    <h3 class="text-xl font-bold mb-2">Notifikasi Panen</h3>
                    <p class="text-base leading-relaxed">Jangan lewatkan waktu panen terbaik! HidroQu akan mengingatkan Anda dengan
                        notifikasi otomatis saat tanaman Anda mendekati masa panen, sehingga hasil panen lebih
                        optimal.</p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="card-body p-4">
                    <div class="w-full h-72 bg-slate-300 mb-4 overflow-hidden rounded-lg">
                        <img src="{{ asset('komunitas.png') }}" class="w-full h-full object-cover object-top" alt="Mockup 2">
                    </div>
                    <h3 class="text-xl font-bold mb-2">Komunitas</h3>
                    <p class="text-base leading-relaxed">Terhubung dengan sesama penggemar hidroponik! Diskusikan tips, berbagi
                        pengalaman, dan temukan inspirasi untuk meningkatkan hasil tanam Anda di fitur komunitas
                        HidroQu.</p>
                </div>
            </div>
        </div>
    ...
    <section id="download" class="scroll-mt-20 bg-neutral text-neutral-content py-16">
        <div class="container mx-auto px-4 flex flex-col items-center">
            ...
            <p class="py-4 text-center max-w-xl">Mulai perjalanan hidroponik Anda sekarang! Unduh aplikasi HidroQu dan
                ...
                gratis!</p>
            <a href="#" class="btn btn-secondary">Download Aplikasi</a>
        </div>
    </section>
</x-app-layout>